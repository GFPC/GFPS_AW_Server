...
@root.route("/demo/manager-invitations")
def demo_manager_invitations_page():
    """Local demo: Bronevik token + team_id → invitations table (manager API)."""
    return send_from_directory(static_folder, "manager_invitations_demo.html")
